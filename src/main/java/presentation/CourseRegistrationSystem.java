	...
	//This method also includes calls to classes implementing the Faculty andStudent USer Stories from Dao Layer
		...
		public static void main(String[] args) throws Exception {
			...
			while("y".equals(ch)) {
				...
				case 1:
					System.out.println("**********************************************************");
					System.out.println("		Register User Window 							  ");
					System.out.println("**********************************************************");
				...
				case 2:
					...
					if(userType !=null && userType.equals("faculty")) {
						...
						while(proceed == 'y') {
							...
							System.out.println("**********************************************************");
							System.out.println("	Please enter an option from the below menu:		 	 ");
							...
							switch(facultyOption) { //faculty options switch open
								...
								case 2: // add new course - faculty area
									...
									System.out.println("**********************************************************");
									System.out.println("		New Course added is below: ");
								...
								case 3: // delete a course - faculty area
									...
									System.out.println("	Input the course ID of the Course 				  ");
								...
								//	everyCourse = courseService.getAllCourses();
									...
									if(updateCoursePojo == null) {
										...
										System.out.println("**********************************************************");
										System.out.println(" 	Select what you want to update in a Course : 	  ");
										...
										switch(updationChoice){ //update courses switch open - faculty area
											...
											case 7: // update Maximum Students Allowed - faculty area
												System.out.println("**********************************************************");
												System.out.println(" 	Input the New Maximum Students Count in this Course :    ");
												System.out.println("**********************************************************");
											...
											case 8: // update all course details - faculty area
												System.out.println("**********************************************************");
												System.out.println(" 		Update all Details of Course 					  ");
												System.out.println("**********************************************************");
											...
											default: // default case update course switch - faculty area
												System.out.println("**********************************************************");
												System.out.println(" 	Wrong Selection.. Please Input the correct option ");
												System.out.println("**********************************************************");
										...
										System.out.println("**********************************************************");
											...
											System.out.println("	Course Cost (USD) : " + updateCoursePojo.getCourseCost());
											System.out.println("	Course Duration (Hours) : " + updateCoursePojo.getCourseDuration());
											System.out.println("	Corse Instructor Name : " + updateCoursePojo.getCourseInstructorName());
											System.out.println("	Course Description : " + updateCoursePojo.getCourseDescription());
											System.out.println("	Maximum Students Allowed  : " + updateCoursePojo.getMaximumStudentsAllowed());
								...
								case 5: // Logout from faculty course registration area case number 5
									System.out.println("**********************************************************");
						...
						while(proceed == 'y') {
							...
							System.out.println("**********************************************************");
							System.out.println("	HELLO "+returnedLoginUserPojo.getUserFirstName()+ " "+returnedLoginUserPojo.getUserLastName()+ "!");
							System.out.println("	Please slect an option from below menu:			  ");
							...
							switch(studentOption) { //student options switch open
								...
								case 4: // view my registered courses - student area
									...
									System.out.println("******************************************************************************************************************************************");
									System.out.println("STUDENT ID\tFIRST NAME\tLAST NAME\tEMAIL ID\\ttCOURSE ID\tCOURSE NAME");
									System.out.println("******************************************************************************************************************************************");
